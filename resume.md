...
- **Databases:** PostgreSQL, MongoDB, Redis, Valkey, DB2
- **Backend Technologies:** REST APIs, gRPC, Microservices Architecture
- **Web Frameworks:** Gin, Echo, Mux, Chi, Fiber
- **ORM:** Gorm, Bun
- **DevOps & Monitoring:** Docker, GitHub Actions, New Relic, Sentry, Uptrace
...
- Optimized BigQuery bulk loading process by implementing CSV-based batch imports, reducing migration time by 80% compared to row-by-row upserts
- Developed data transformation logic to ensure schema compatibility and data integrity during cross-platform migration
...
- Architected and developed key features for Homer App:
  - AI-powered home valuation system with batch processing for monthly refresh cycles
  - Singpass integration for secure user verification
  - Address management system and real-time market transaction analytics
  - Intelligent buyer-property matching engine
  - Financial calculation suite (mortgage, affordability, cash proceeds)
  - Property search system
- Built workflow engine for listing presentation integrating Calendly, Google Calendar, Google Contact, WhatsApp, and HubSpot
- Implemented New Relic APM to enhance system reliability and performance monitoring
- Led code review processes maintaining high code quality standards
- Delivered timely hotfixes for production and legacy systems, reducing downtime and improving system stability
...
**Universitas Muhammadiyah Malang** | Bachelor's Degree, Informatics Engineering | Aug 2012 - Aug 2018  
Malang, Indonesia
